    ...
    <div style={authPageStyle}>
      ...
      <div style={authCardStyle} className="fade-in">
        <div style={{ marginBottom: 32 }}>
          ...
          <h1 style={{ fontSize: 28, fontWeight: 700, marginBottom: 6 }}>Create account</h1>
          <p style={{ color: 'var(--text-muted)', fontSize: 14 }}>Start managing tasks with your team</p>
        </div>
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
          ...
          <button type="submit" className="btn btn-primary"
            disabled={loading} style={{ marginTop: 4, padding: '12px 20px' }}>
